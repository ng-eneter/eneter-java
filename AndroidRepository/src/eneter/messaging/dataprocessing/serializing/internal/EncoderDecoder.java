...
public class EncoderDecoder
{
    ...
    public String readPlainString(DataInputStream reader, Charset stringEncoding, boolean isLittleEndian) throws IOException
    {
        ...
        // Note: Android 2.1 does not support Charset in String constructor.
        String aCharsetName = stringEncoding.name();
        String aResult = new String(aStringBytes, aCharsetName);
        return aResult;
    }
